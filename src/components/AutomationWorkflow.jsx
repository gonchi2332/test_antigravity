                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="w-20 h-20 bg-gray-800 rounded-2xl flex items-center justify-center mb-6 border border-gray-700 shadow-lg relative group">
                                    <step.icon className="w-10 h-10 text-mineral-green group-hover:text-white transition-colors duration-300" />
